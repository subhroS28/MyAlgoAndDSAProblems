 ...
 *
 * NOTE:- In the below questions we need d/f arrays for storing some value. First:-
 *          a. dp[] is needed to store the lis number for that index    [Thus will always be needed]
 *          b. hash[] or track[] is needed to know the track of the index   [This will only be needed when we have to
 *             print the path or return the complete path]
 *          c. count[] store the frequency of any particular lis. It will be needed only when we want to know the count
 *              of any particular is.
 */
